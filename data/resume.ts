...
export const experience = [
  {
    ...
    highlights: [
      ...
      "Designed and optimized SQL Server databases and queries.",
      "Provided application support, troubleshooting and system maintenance.",
      "Prepared system documentation and process flows.",
      "Conducted user training sessions for MVC, VBA, RPA and Power Platform.",
    ],
  },
];
